...
async function callClaude(messages, systemPrompt) {
  ...
  if (!apiKey) return 'API key not configured. Add VITE_ANTHROPIC_API_KEY to Vercel environment variables.';
  try {
    ...
    return 'Error connecting to AI. Check your API key in Vercel.';
  }
}
